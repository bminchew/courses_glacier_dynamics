...
\caption{Maxwell relaxation time $t_M = 1/(2\mu A\,\tau_e^{\,n-1})$ as a function of temperature and effective stress, computed using the Arrhenius relation for $A(T)$.  Contour labels indicate the relaxation time in human-readable units.  Black dots mark the five settings from Table~\ref{tab:maxwell_times}.}
